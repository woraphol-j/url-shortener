...
func (m *MockDAO) Get(arg0 string) (*ShortURL, error) {
...
func (m *MockDAO) Save(arg0 *ShortURL) error {
...
func (m *MockDAO) Truncate() (int64, error) {
...
func (mr *MockDAOMockRecorder) Truncate() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Truncate", reflect.TypeOf((*MockDAO)(nil).Truncate))
}
